...
const compressImage = async (req, res, next) => {
   ...
   sharp(`${config.rootPath}/public/images/products/${product.image_url}`)
      .resize(500)
      .toBuffer((err, buffer) => {
         fs.writeFileSync(`${product.image_url}`, buffer);
         path.resolve(config.rootPath, `public/images/products/compressed`);
...
module.exports = { store, index, update, destroy, compressImage };
